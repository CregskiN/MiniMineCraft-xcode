...
void initGame() {
	try {
		skyDome = new SkyDome(
			"/Users/cregskin/code/c/_minecraft/_minecraft/resources/skyDome/blueSkyWithCloud",
			"Cam_2_Left+X.png", "Cam_3_Right-X.png",
			"Cam_4_Up+Y.png", "Cam_5_Down-Y.png",
			"Cam_0_Front+Z.png", "Cam_1_Back-Z.png",
			"/Users/cregskin/code/c/_minecraft/_minecraft/shader/skyDome.vs", "/Users/cregskin/code/c/_minecraft/_minecraft/shader/skyDome.fs");
		skyDome->init();
		cout << "天顶球加载完毕" << endl;
	}
	catch (std::bad_alloc) {
