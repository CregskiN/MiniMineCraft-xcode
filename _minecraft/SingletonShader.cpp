...
{
	if (!simpleShader) {
		simpleShader = new Shader("/Users/cregskin/code/c/_minecraft/_minecraft/shader/model_without_light.vs", "/Users/cregskin/code/c/_minecraft/_minecraft/shader/model_without_light.fs");
		simpleShader->use();
...
Shader * SingletonShader::getSkyDomeShader() {
	if (!skyDomShader) {
		skyDomShader = new Shader("/Users/cregskin/code/c/_minecraft/_minecraft/shader/skyDome.vs", "/Users/cregskin/code/c/_minecraft/_minecraft/shader/skyDome.fs");
	}
	return skyDomShader;
}
...
{
	if (!lightShader) {
		lightShader = new Shader("/Users/cregskin/code/c/_minecraft/_minecraft/shader/model_load_with_light.vs", "/Users/cregskin/code/c/_minecraft/_minecraft/shader/model_load_with_light.fs");
		lightShader->use();
